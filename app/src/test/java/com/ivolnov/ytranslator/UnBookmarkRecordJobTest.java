...
/**
 * {@link UnBookmarkRecordJob} local unit tests.
 *
...
public class UnBookmarkRecordJobTest {
    ...
    public void runTest() throws Exception {
        ...
        final UnBookmarkRecordJob job = new UnBookmarkRecordJob(database, onComplete)
                .withIndex(ID);
